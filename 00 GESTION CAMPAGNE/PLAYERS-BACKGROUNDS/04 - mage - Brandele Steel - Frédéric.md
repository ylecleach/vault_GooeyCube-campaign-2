...
Feats: Mage Offensif (Artilleur).

===

Fred veut faire identifier des objets magiques, et aussi apprendre à Scribe Scroll. 

Chapitre 2 

Session 1 :

Frédéric eu l'idée de controler avec la bague de feu (maudite) les morts vivants de la rencontre [[Area B - The Skeletal Hand X]] 

Il ne sait pas que la bague est maudite , mais s'en doute car la bague chauffe. Il n'a pas encore essayer de l'enlever.
...
###  Premier Spell Book trouvé
Le magicien des bandits portait sur lui  un livre de sorts contenant les sorts suivants : 
- niv 1 : Flowblades (Zyathé Magicka)
- niv 1 : Tintinnabulation (Zyathé Magicka)
- niv 1 : Stoneblast (Zyathé Magicka)
- niv 1 : Disguise Self 
- niv 1 : Rycroft’s Regal Raiments (Zyathé Magicka)
- niv 1 : Alarm
- niv 2 : Flowstones Detection. (Zyathé Magicka)
- niv 2 : Hold Person
- niv 2 : Invisibility
- niv 2 : Darkvision
- niv 3 : Lighting Bolt

### Second Spell book trouvé

Un petit livre de sorts de voyage dans une pochette en cuir contenant les éléments suivants

sorts - Cantrips : Lumière dansante, Amis, Message, Poison

Poison, Rayon de givre, Appel aux morts. Premier niveau : Effroi, Charme, Détection de la magie, Identification des morts,

Charme de la personne, Détection de la magie, Identification, Armure de mage, Missile magique, Trait de sorcière.

Missile magique, Trait de sorcière. Deuxième niveau : Flou, Vision dans le noir, Sphère enflammée et Rayon d'affaiblissement.

Neuf autres sorts peuvent être ajoutés au livre avant qu'il ne soit complet.

Sur le devant du livre de sorts se trouve une inscription montrer le **document 58 : Inscription du livre de sorts.

### FEEDBACK 1
 Feedback =
 moins aimé : au début dans le camp à tourner en rond avec les tente. (un peu longuet), trop dirigé pour aller dans toutes les tentes, certaines tentes u peu moins bien.
 L'histoire est très complexe, et parfois on perd un peu le fil.
 pleins de ramification, dont certaines on ne sait pas.
 des lieux qui s'ouvrent.
 une accumulation de trop "d'ouverture" de pistes d'aventures mais auxquels les joueurs ne peuvent pas y aller par design de l'aventure.

 scenario très poussé, original, très dértaillé, des modes de jeux différents, horreur, enquete, infiltration.

combat trop facile: groupe trop fort , trop équipé.

des monstres originaux (cube vert, esprit dans la chaudiere).


## A developer:
- son lore / histoire personnelle
- le cube gélatineux Gober


## Pass&ge niv 4
Niv 4
+2 en I : 20 (le max) => aug le nb de sorts = 7

4+5 = 9 sorts preparés par jour
4 emplacements de niv 1
3 emplacement de niv 2

+7 : bonus attack de sorts
...
sorts connus dans grimoire: 12 + cantrips (5)
...
- definir limite grimoire actuel
- revoir regle copie de sorts et sorts max spell books.
- relire les règles classe de mage`

### Feedback 2 - 18 JAN 2024
- en tant que joueur : vos feedbacks / ressentis sur les parties. ce que vous aimez, ce que vous aimez moins.  

chapter 3 plus dynamique, moins lassant que le chapter 1
pistes 
trop dirigé par les PNJ du camp, ils sont pas si fort que cela : pas très crédible.
frustrant de pas pouvoir visiter le monde.
trop scripté / dirigiste
des pistes ouvertes qui s'évapore : fait perdre le fil de l'histoire.
cela par trop partout.

il y a des trucs très cool : enigmes, des mobs avec humour.

Le scenario : ne voir pas bien. bcp d'evénements, sans comprendre le lien entre eux.

les objectifs ne sont pas clairs.

cela fait l'impression que les scenarios sont plus fait pour des joueurs débutants.

il manque des bulles de slow down : ville / echange / enquete / repos.

bcp d'humour , référence à la pop culture.
...
### Grimoire au 19 mai (avt niv 5)

niv 0 : lumière, main de mage, prestidigitation, rayon de givre, trait de feu
niv1: familier, armure de mage, bouclier, compréhension des langues, détection de la magie, graisse, identification, projectile magique,
niv2: mysty step, image miroir, rayon ardent, toile d'araignée

### Proposition de sorts trouvé dans le spellbook appelé Atlas des Horizons infinis.

L'objet magique Atlas des Horizons infinis, dans sa description original est vraiment trop balèze. c'est typiquement un objet de quête.

Je te propose donc de le transformer en un livre de sorts classique avec cette liste de sorts que j'ai concocté avec un mix de sorts standards (3) et de Zyathé (4). Ils sont tous très utiles, notamment le Sending qui est je trouve super balèze. La petite Hutte vient de mon expérience de joueur, et c'est un sort qui est encore utilisé pour le groupe, même à très haut niveau...

1. Boule de Feu - niv3
2. Zythic Bolt - niv 3 - gooeycube
3. Force Darts - niv 0 - gooeycube
4. Flowstride - niv 2 - gooeycube
5. Hat Entrapment - niv 2 - gooeycube
6. Petite Hutte de Leomund - niv 3 => https://www.aidedd.org/dnd/sorts.php?vf=petite-hutte-de-leomund
7. Sending (communication à distance) - niv3


**Zythic Bolt**
Sort d'Évocation de Niveau 3. Ce sort est explicitement listé comme un sort unique à Zyathé14 et fait partie des sorts de Cycle 311. Sa description indique qu'il appelle l'énergie brute du Zyanthuus15 sous la forme d'un rayon de couleurs scintillantes12. Ce sort nécessite une Pierre de Flux taillée d'une valeur d'au moins 100 Golds, recouverte de suie, comme composante matérielle12. Il force les créatures dans une ligne de 90 pieds et 5 pieds de large à effectuer un jet de sauvegarde de Dextérité, infligeant 4d4 dégâts de foudre et 4d4 dégâts de force en cas d'échec, et aveuglant la cible pendant une minute12. En cas de succès, les dégâts sont réduits de moitié et l'aveuglement est évité12. Aux niveaux supérieurs (Niveau 4 et plus), les dégâts augmentent16.

**Force Darts**
Evocation cantrip
Casting Time: 1 action
Range: 30 feet
Components: V, S, M (a pin or needle)
Duration: Instantaneous
Classes: Agent, Bard, Courtmage, Flowcaster, Sorcerer, Spelldancer,
Warlock, Wizard
**Description**: A slender dart of pure energy streaks toward a creature
within range. Make a ranged spell attack against the target.
On a hit, the target takes 1d6 force damage. In addition, the creature
struck is pushed 5 feet away from you.
**At Higher Levels**: This spell’s damage increases by 1d6 when you
...
Components: V
Duration: Instantaneous
Classes: Agent, Bard, Flowcaster, Fusilier, Sorcerer, Spelldancer,
Warlock, Wizard
**Description**: As a reaction to being hit by a melee attack, brightly
glittering sparkles of light surround you as you teleport up to
30 feet away to an unoccupied space that you can see. A glowing
replica of yourself is left behind until the end of your next turn as a
distraction before it disperses with a mocking laugh. At the end of
your next turn, the replica disperses, dealing 1d4 psychic damage
to all creatures within 5 feet of that location. A creature can use its
action to attempt to discern that the replica is not you by by succeeding
on an Intelligence (Investigation) skill check against your
spell save DC. A creature that attacks the replica or interacts with
it in any way will automatically determine that it is an illusion.
At Higher Levels: When you cast this spell using a spell slot of
3rd-level or higher, the replica’s damage increases by 1d4 for each
...
Casting Time: 1 action
Range: 60 feet
Components: V, S, M (a hat)
Duration: Concentration, up to 1 minute
Classes: Bard, Courtmage, Flowcaster, Sorcerer, Warlock, Wizard
Description: You toss a hat at a Medium sized or smaller target
within range. Make a ranged spell attack against the target. On a
hit, the hat enlarges and completely envelopes the target for the
duration unless the target succeeds on a Dexterity saving throw
at DC 10 + your spellcasting ability modifier. On a success, the
target is not enveloped but takes 1d8+2 force damage. For game
purposes, the interior of the hat is considered to be an extradimensional
space.
While enveloped by the hat, the target is blinded, deafened,
restrained, and has total cover. Attacks and spells can't cross
through the entrance into or out of the extradimensional space.
At the start of each of its turns, the target can use its action to
attempt a Strength (Athletics) skill check. On a success, the target
breaks free of its entrapment and the spell ends. When the
spell ends, the hat reappears unharmed within 5 feet of you in a
location of your choice.
At Higher Levels: When you cast this spell using a spell slot of
3rd or 4th-level, you may now target creatures of size Large or
smaller and the force damage is 2d8+4. When you use a spell slot
of 5th-level or 6th-level, you can target creatures of size Huge or
smaller and the force damage is 3d8+6. When you use a spell slot
